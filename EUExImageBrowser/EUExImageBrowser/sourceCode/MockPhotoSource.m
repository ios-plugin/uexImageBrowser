...
//startPhotoIndex = _startPhotoIndex;
///////////////////////////////////////////////////////////////////////////////////////////////////
// private
...
- (id)initWithType:(MockPhotoSourceType)type startIndex:(NSInteger)startIndex title:(NSString*)title photos:(NSArray*)photos
...
- (id)init {
	return [self initWithType:MockPhotoSourceNormal startIndex:0 title:nil photos:nil photos2:nil];
}
